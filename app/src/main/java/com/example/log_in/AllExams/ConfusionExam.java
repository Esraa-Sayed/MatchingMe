...
public class ConfusionExam extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ExamQ < 5)
                {
                    Toast.makeText(ConfusionExam.this,"جاوب علي جميع الاسأله",Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    AlertDialog dialog;
                    builder = new AlertDialog.Builder(ConfusionExam.this);
    ...
    void putImg()
    {
        ...
        TheQuastion.setText(R.string.chooseConfusionFace);
        Q1Answerimg = findViewById(R.id.Q1Answerimg);  Q1Answerimg.setImageResource(R.drawable.haqer5);
        image2Q1 = findViewById(R.id.image2Q1);        image2Q1.setImageResource(R.drawable.laugh12);
        image3Q1 = findViewById(R.id.image3Q1);        image3Q1.setImageResource(R.drawable.sadkind2);

        Q2Answerimg = findViewById(R.id.Q2Answerimg);   Q2Answerimg.setImageResource(R.drawable.confused_cartoon);
        image2Q2 = findViewById(R.id.image2Q2);         image2Q2.setImageResource(R.drawable.cry_car);
        image3Q2 = findViewById(R.id.image3Q2);         image3Q2.setImageResource(R.drawable.worry_carton);

        Q3Answerimg = findViewById(R.id.Q3Answerimg);    Q3Answerimg.setImageResource(R.drawable.haqer);
        ...
        Q4Answerimg = findViewById(R.id.Q4Answerimg);    Q4Answerimg.setImageResource(R.drawable.haqer_cartoon);
        ...
        Q5Answerimg = findViewById(R.id.Q5Answerimg);    Q5Answerimg.setImageResource(R.drawable.haqer2);
        image2Q5 = findViewById(R.id.image2Q5);           image2Q5.setImageResource(R.drawable.happy);
        image3Q5 = findViewById(R.id.image3Q5);            image3Q5.setImageResource(R.drawable.surprise3);
    }
    @Override
