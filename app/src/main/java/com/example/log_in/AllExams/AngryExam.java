...
public class AngryExam extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
 ...
 TextView TheQuastion;
    ...
    void putImg()
    {
        ...
        TheQuastion.setText(R.string.chooseAngerFace);
        Q1Answerimg = findViewById(R.id.Q1Answerimg);  Q1Answerimg.setImageResource(R.drawable.anger);
        image2Q1 = findViewById(R.id.image2Q1);        image2Q1.setImageResource(R.drawable.happy);
        image3Q1 = findViewById(R.id.image3Q1);        image3Q1.setImageResource(R.drawable.sad);

        Q2Answerimg = findViewById(R.id.Q2Answerimg);   Q2Answerimg.setImageResource(R.drawable.angry_cartoon5);
        image2Q2 = findViewById(R.id.image2Q2);         image2Q2.setImageResource(R.drawable.aboos);
        image3Q2 = findViewById(R.id.image3Q2);         image3Q2.setImageResource(R.drawable.confused_cartoon);

        Q3Answerimg = findViewById(R.id.Q3Answerimg);    Q3Answerimg.setImageResource(R.drawable.angery2);
        image2Q3 = findViewById(R.id.image2Q3);           image2Q3.setImageResource(R.drawable.happy2);
        image3Q3 = findViewById(R.id.image3Q3);            image3Q3.setImageResource(R.drawable.sad2);


        Q4Answerimg = findViewById(R.id.Q4Answerimg);    Q4Answerimg.setImageResource(R.drawable.anger4);
        image2Q4 = findViewById(R.id.image2Q4);           image2Q4.setImageResource(R.drawable.surprise6);
        image3Q4 = findViewById(R.id.image3Q4);            image3Q4.setImageResource(R.drawable.sad6);


        Q5Answerimg = findViewById(R.id.Q5Answerimg);    Q5Answerimg.setImageResource(R.drawable.angercartoones);
        image2Q5 = findViewById(R.id.image2Q5);           image2Q5.setImageResource(R.drawable.smile_cartoon);
        image3Q5 = findViewById(R.id.image3Q5);            image3Q5.setImageResource(R.drawable.scared_cartoon);
    }
    @Override
