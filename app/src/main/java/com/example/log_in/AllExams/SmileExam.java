...
public class SmileExam extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ExamQ < 5)
                {
                    Toast.makeText(SmileExam.this,"جاوب علي جميع الاسأله",Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    AlertDialog dialog;
                    builder = new AlertDialog.Builder(SmileExam.this);
    ...
    void putImg()
    {
        ...
        TheQuastion.setText(R.string.chooseSmileFace);
        Q1Answerimg = findViewById(R.id.Q1Answerimg);  Q1Answerimg.setImageResource(R.drawable.mobtasem);
        image2Q1 = findViewById(R.id.image2Q1);        image2Q1.setImageResource(R.drawable.sad_cartoon2);
        image3Q1 = findViewById(R.id.image3Q1);        image3Q1.setImageResource(R.drawable.kaeeb);

        Q2Answerimg = findViewById(R.id.Q2Answerimg);   Q2Answerimg.setImageResource(R.drawable.smile4);
        image2Q2 = findViewById(R.id.image2Q2);         image2Q2.setImageResource(R.drawable.sadkind2);
        image3Q2 = findViewById(R.id.image3Q2);         image3Q2.setImageResource(R.drawable.sadkind3);

        Q3Answerimg = findViewById(R.id.Q3Answerimg);    Q3Answerimg.setImageResource(R.drawable.smile5);
        image2Q3 = findViewById(R.id.image2Q3);           image2Q3.setImageResource(R.drawable.cryingkid2);
        image3Q3 = findViewById(R.id.image3Q3);            image3Q3.setImageResource(R.drawable.surprise3);


        Q4Answerimg = findViewById(R.id.Q4Answerimg);    Q4Answerimg.setImageResource(R.drawable.smile3);
        image2Q4 = findViewById(R.id.image2Q4);           image2Q4.setImageResource(R.drawable.surprise6);
        image3Q4 = findViewById(R.id.image3Q4);            image3Q4.setImageResource(R.drawable.disgust);


        Q5Answerimg = findViewById(R.id.Q5Answerimg);    Q5Answerimg.setImageResource(R.drawable.smile);
        image2Q5 = findViewById(R.id.image2Q5);           image2Q5.setImageResource(R.drawable.contempt);
        image3Q5 = findViewById(R.id.image3Q5);            image3Q5.setImageResource(R.drawable.surprise4);
    }
    @Override
