...
public class laughExam extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ExamQ < 5)
                {
                    Toast.makeText(laughExam.this,"جاوب علي جميع الاسأله",Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    AlertDialog dialog;
                    builder = new AlertDialog.Builder(laughExam.this);
    ...
    void putImg()
    {
        ...
        TheQuastion.setText(R.string.chooseLaughFace);
        Q1Answerimg = findViewById(R.id.Q1Answerimg);  Q1Answerimg.setImageResource(R.drawable.laugh12);
        image2Q1 = findViewById(R.id.image2Q1);        image2Q1.setImageResource(R.drawable.sadkind2  );
        image3Q1 = findViewById(R.id.image3Q1);        image3Q1.setImageResource(R.drawable.haqer5);

        Q2Answerimg = findViewById(R.id.Q2Answerimg);   Q2Answerimg.setImageResource(R.drawable.laugh);
        image2Q2 = findViewById(R.id.image2Q2);         image2Q2.setImageResource(R.drawable.worry_carton);
        image3Q2 = findViewById(R.id.image3Q2);         image3Q2.setImageResource(R.drawable.cry_car);

        Q3Answerimg = findViewById(R.id.Q3Answerimg);    Q3Answerimg.setImageResource(R.drawable.laugh10);
        image2Q3 = findViewById(R.id.image2Q3);           image2Q3.setImageResource(R.drawable.haqer);
        image3Q3 = findViewById(R.id.image3Q3);            image3Q3.setImageResource(R.drawable.surprise2);


        Q4Answerimg = findViewById(R.id.Q4Answerimg);    Q4Answerimg.setImageResource(R.drawable.happy_cartoon2 );
        image2Q4 = findViewById(R.id.image2Q4);           image2Q4.setImageResource(R.drawable.haqer_cartoon);
        image3Q4 = findViewById(R.id.image3Q4);            image3Q4.setImageResource(R.drawable.mondahesh);


        Q5Answerimg = findViewById(R.id.Q5Answerimg);    Q5Answerimg.setImageResource(R.drawable.happy );
        image2Q5 = findViewById(R.id.image2Q5);           image2Q5.setImageResource(R.drawable.surprise3);
        image3Q5 = findViewById(R.id.image3Q5);            image3Q5.setImageResource(R.drawable.haqer2);
    }
    @Override
